...
class Driver(MainBox):
    def __init__(self, name, descrip, idnum, loc, status, toolage, head):
...
driver1 = Driver('philips', '4 inch', 101, 'site one', 'out', '3 years',  'flat')
driver2 = Driver('philips', '6 inch', 102, 'site one', 'in', '1 years','ronson')
hammer1 = Hammer('regal', '12 inch', 201, 'site three', 'out', 'non power', 150, 'long')
...
print(driver2.name, driver2.status, driver2.loc, driver2.idnum)
print(emp101.name, emp101.status, emp101.contact)

print(driver2.name, driver2.descrip, driver2.idnum)
print(driver1.name, driver1.status, driver1.loc, driver1.idnum)
print(emp101.name, emp101.status, emp101.contact)
print(hammer1.idnum, hammer1.name)
